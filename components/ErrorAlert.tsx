...
import { connectFailed } from '../redux/blockchain/blockchainActions';
...
export const ErrorAlert = ({ hidden, setHidden, errorMsg }: Props) => {
    ...
    return (
        <div className='relative select-none'>
            <div
                id='alert-border-2'
                className={
                    'flex z-10 p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200 fixed bottom-5 transition-all duration-300 ' +
                ...
                <div className='ml-3 pr-4 text-sm font-medium text-red-700 transition-all'>{errorMsg}</div>
                <button
                    type='button'
                    onClick={() => {
                        setHidden();
