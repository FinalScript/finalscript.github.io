    ...
    return (
        <div className='relative'>
            <div
                id='alert-border-2'
                className={
                    'flex p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200 fixed bottom-5 transition-all duration-300 ' +
                ...
                <div className='ml-3 text-sm font-medium text-red-700 transition-all'>{errorMsg}</div>
                <button
                    type='button'
                    onClick={() => {
                        setHidden();
