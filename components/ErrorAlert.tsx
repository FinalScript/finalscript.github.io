...
export const ErrorAlert = ({ deleteBy, errorMsg }: Props) => {
    ...
    return (
        <div
            id='alert-border-2'
            className={'flex tracking-widest mx-auto w-[400px] p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200 transition-all duration-300 '}
            role='alert'>
