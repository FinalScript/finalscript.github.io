    ...
    return (
        <section className='text-gray-400 bg-gray-900 body-font h-screen flex items-center'>
            ...
            <div className='container mx-auto flex px-5 md:flex-row justify-center items-center'>
                <div className='w-400px bg-zinc-900 text-gray-200 bg-opacity-50 rounded-xl shadow-center-lg shadow-zinc-800 px-6 py-5 flex flex-col md:mt-0'>
                    ...
                    <div className='relative mb-4 flex justify-between'>
                        <h5 className='text-xs text-gray-500'>
                            ...
                            value. By buying you agree to the{' '}
                            <Link href={'/tos'}>
